...
class Sidebar_Admin extends StatefulWidget {
  ...
  const Sidebar_Admin({super.key, required this.selectedKey});

  @override
  State<Sidebar_Admin> createState() => _SidebarState();
}

class _SidebarState extends State<Sidebar_Admin> {
              ...
              Expanded(
                child: Directionality(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildMenuItem("assets/images/control.png", "لوحة التحكم",
                          itemPadding, screenHeight),
                      _buildMenuItem("assets/images/Banknote 2.png", "الإيرادات",
                          itemPadding, screenHeight),
                      _buildMenuItem("assets/images/exp.png",
                          "المصروفات", itemPadding, screenHeight),
                      _buildMenuItem("assets/images/profit.png",
                          "الأرباح", itemPadding, screenHeight),
                      _buildMenuItem("assets/images/operations.png", "الموظفين",
                          itemPadding, screenHeight),
                          _buildMenuItem("assets/images/customers.png", "العملاء",
                          itemPadding, screenHeight),
                    ],
                  ),
                ),
